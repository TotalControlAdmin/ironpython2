...
[assembly: PythonModule("binascii", typeof(IronPython2.Modules.PythonBinaryAscii))]
...
both encoded.  When quotetabs is set, space and tabs are encoded.")]
        public static object b2a_qp(string data, [DefaultParameterValue(0)] int quotetabs, [DefaultParameterValue(1)] int istext, [DefaultParameterValue(0)] int header) {
