...
module, or raises ResourceImportError if it wasn't found."
        ...
        public object load_module(CodeContext /*!*/ context, string fullname) {
            ...
            if (ispackage) {
                ...
                var pkgpath = IronPython2.Runtime.Operations.PythonOps.MakeList();
        ...
        private static Exception MakeError(params object[] args) {
            return IronPython2.Runtime.Operations.PythonOps.CreateThrowable(PythonExceptions.ImportError, args);
        }
