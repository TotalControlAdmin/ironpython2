...
using PythonList = IronPython2.Runtime.List;
using System.Runtime.InteropServices;
using AstExpression = IronPython2.Compiler.Ast.Expression;

using System.Numerics;

[assembly: PythonModule("_ast", typeof(IronPython2.Modules._ast))]
    ...
    public static class _ast
    {
        ...
        public abstract class AST
        {
            ...
            internal static expr Convert(ConstantExpression expr) {
                ...
                else if (expr.Value is IronPython2.Runtime.Bytes)
        ...
        public class keyword : AST
        {
            ...
            internal keyword(IronPython2.Compiler.Ast.Arg arg)
                : this() {
                _arg = arg.Name;
        ...
        public class BoolOp : expr
        {
            ...
            internal override AstExpression Revert() {
                if (op == And.Instance || op is And) {
                    ...
                    return ae;
                } else if (op == Or.Instance || op is Or) {
        ...
        {
            internal static readonly TrueDivide Instance = new TrueDivide();
        ...
        public class Lambda : expr
        {
            ...
            internal Lambda(LambdaExpression lambda)
                ...
                if (statement is Return)
                    ...
                    // it comes back with:
                    //
                    //IronPython2.Compiler.Ast.LambdaExpression
                    //IronPython2.Compiler.Ast.FunctionDefinition<lambda$334>generator
                    //  IronPython2.Compiler.Ast.Parameter  x
                    //  IronPython2.Compiler.Ast.ExpressionStatement
                    //    IronPython2.Compiler.Ast.YieldExpression     <<<<<<<<
                    //      IronPython2.Compiler.Ast.YieldExpression   <<<<<<<< why twice?
                    //        IronPython2.Compiler.Ast.NameExpression x
