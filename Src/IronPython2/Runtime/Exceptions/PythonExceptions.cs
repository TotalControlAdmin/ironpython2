...
[assembly: PythonModule("exceptions", typeof(IronPython2.Runtime.Exceptions.PythonExceptions))]
namespace IronPython2.Runtime.Exceptions {
    ...
    /// and therefore is built-in to IronPython2.dll instead of IronPython2.Modules.dll.
    /// 
    /// The exception mapping mechanism is exposed as internal surface area available to only
    /// IronPython / IronPython2.Modules.dll.  The actual exceptions themselves are all public.
    /// 
