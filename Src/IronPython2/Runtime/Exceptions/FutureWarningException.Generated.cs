...
namespace IronPython2.Runtime.Exceptions {
    #region Generated FutureWarningException
    ...
    public class FutureWarningException : WarningException, IPythonAwareException {
        ...
        public FutureWarningException() : base() { }
        public FutureWarningException(string msg) : base(msg) { }
        public FutureWarningException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected FutureWarningException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.FutureWarning);
