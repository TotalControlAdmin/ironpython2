...
namespace IronPython2.Runtime.Exceptions {
    #region Generated SyntaxWarningException
    ...
    [Serializable]
    public class SyntaxWarningException : WarningException, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public SyntaxWarningException() : base() { }
        public SyntaxWarningException(string msg) : base(msg) { }
        public SyntaxWarningException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected SyntaxWarningException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.SyntaxWarning);
