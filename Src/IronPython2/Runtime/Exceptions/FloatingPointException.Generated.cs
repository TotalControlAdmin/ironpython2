...
namespace IronPython2.Runtime.Exceptions {
    #region Generated FloatingPointException
    ...
    public class FloatingPointException : Exception, IPythonAwareException {
        ...
        public FloatingPointException() : base() { }
        public FloatingPointException(string msg) : base(msg) { }
        public FloatingPointException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected FloatingPointException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.FloatingPointError);
