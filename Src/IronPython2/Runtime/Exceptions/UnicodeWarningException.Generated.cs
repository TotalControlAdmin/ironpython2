...
namespace IronPython2.Runtime.Exceptions {
    #region Generated UnicodeWarningException
    ...
    [Serializable]
    public class UnicodeWarningException : WarningException, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public UnicodeWarningException() : base() { }
        public UnicodeWarningException(string msg) : base(msg) { }
        public UnicodeWarningException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected UnicodeWarningException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.UnicodeWarning);
