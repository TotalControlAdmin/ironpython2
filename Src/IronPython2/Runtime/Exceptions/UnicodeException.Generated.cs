...
namespace IronPython2.Runtime.Exceptions {
    #region Generated UnicodeException
    ...
    [Serializable]
    public class UnicodeException : Exception, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public UnicodeException() : base() { }
        public UnicodeException(string msg) : base(msg) { }
        public UnicodeException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected UnicodeException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.UnicodeError);
