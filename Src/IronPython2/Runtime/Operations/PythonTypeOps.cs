...
namespace IronPython2.Runtime.Operations {
    internal static class PythonTypeOps {
        ...
        private static object GetInitMethod(CodeContext/*!*/ context, PythonType dt, object newObject) {
            ...
            for (int i = 0; i < dt.ResolutionOrder.Count; i++) {
                ...
                if (cdt.IsOldClass) {
                    ...
                    // detect old-style if the user imports a IronPython2.NewTypes
                    // type.
                }
        ...
        internal static bool IsRuntimeAssembly(Assembly assembly) {
            if (assembly == typeof(PythonOps).Assembly || // IronPython2.dll
            ...
            if (assemblyName.Name.Equals("IronPython2.Modules")) { // IronPython2.Modules.dll
                return true;
            }
...
#pragma warning restore 169
        ...
        internal static string GetDocumentation(Type type) {
            ...
            var docAttr = type.GetCustomAttributes(typeof(DocumentationAttribute), false);
