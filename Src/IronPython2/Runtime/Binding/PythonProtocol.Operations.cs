...
namespace IronPython2.Runtime.Binding {
    ...
    static partial class PythonProtocol {
        ...
        /// IronPython2.  It is implemented by calling the __contains__ method on x and
        /// passing in y.  
        /// 
                    ...
                    Ast.AndAlso(
                        ...
                        Ast.NotEqual(
                            Ast.Assign(
                                coerceTuple,
                                Ast.Call(
                                    typeof(PythonOps).GetMethod(nameof(PythonOps.ValidateCoerceResult)),
                                    coerceResult
                                )
                            ),
                            AstUtils.Constant(null)
        ...
        class SliceBuilder : IndexBuilder {
            ...
            private DynamicMetaObject/*!*/ MakeBigIntTest(DynamicMetaObject/*!*/ self, DynamicMetaObject/*!*/ bigInt) {
                ...
                return new DynamicMetaObject(
                    Ast.Call(
                        typeof(PythonOps).GetMethod(nameof(PythonOps.NormalizeBigInteger)),
                        self.Expression,
                        bigInt.Expression,
                        _lengthVar
                    ),
            ...
            private Expression/*!*/ MakeGetLength(DynamicMetaObject /*!*/ self) {
                ...
                return Ast.Call(
                    typeof(PythonOps).GetMethod(nameof(PythonOps.GetLengthOnce)),
                    self.Expression,
                    _lengthVar
                );
            }
